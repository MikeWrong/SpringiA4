...
public class EnvironmentInjectionTest {
    ...
    @RunWith(SpringJUnit4ClassRunner.class)
    @ContextConfiguration(classes = EnvironmentAndPlaceholderConfig.class)
    public static class environmentAndPlaceholderConfig {
    ...
    @RunWith(SpringJUnit4ClassRunner.class)
    @ContextConfiguration("classpath:Externals.xml")
